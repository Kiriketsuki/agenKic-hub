---
name: parallel-fix
description: "Spawns parallel agents in isolated worktrees to fix bugs using competing strategies (minimal patch, refactor, rewrite). Each agent runs the test suite independently. The winning fix is the smallest passing diff. Chains from council-supervisor via --from-council. Triggers: \"parallel fix\", \"race fix\", \"/parallel-fix\"."
---
