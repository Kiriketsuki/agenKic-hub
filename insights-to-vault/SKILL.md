...
description: >
  Archives a Claude Code Insights report into the Obsidian vault after running /insights.
  Use this skill immediately whenever the user says "copy it to the vault", "save to vault",
  "archive the insights", "add it to the vault", or any similar phrase after running /insights.
