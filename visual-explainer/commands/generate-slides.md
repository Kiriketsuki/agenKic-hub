...
If `--publish` is specified, write to `./docs/html/slides/`. Otherwise write to `/tmp/visual-explainer/`. Open the result in the browser and tell the user the file path.
