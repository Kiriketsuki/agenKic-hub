...
If `--publish` is specified, write to `./docs/visual-explainer/diagrams/`. Otherwise write to `/tmp/visual-explainer/`. Open the result in the browser and tell the user the file path.
