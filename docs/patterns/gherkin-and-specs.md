...
The repo's [feature-spec skill](https://github.com/Kiriketsuki/agenKic-hub/blob/main/skills/core/feature-spec/SKILL.md) produces feature specifications that use two conventions: Gherkin for acceptance scenarios and MoSCoW for scope. This article explains both, for a reader who has never seen either.
...
The [implement-spec skill](https://github.com/Kiriketsuki/agenKic-hub/blob/main/skills/core/implement-spec/SKILL.md) consumes these specs and turns the scenarios into tasks for subagents.
