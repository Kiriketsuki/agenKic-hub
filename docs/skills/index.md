...
| [continuous-learning-v2](https://github.com/Kiriketsuki/agenKic-sKills/blob/main/skills/continuous-learning-v2/SKILL.md) | Instinct-based learning system that observes sessions via hooks, creates atomic instincts with confidence scoring, and evolves them into skills, commands, or agents. |
...
| [model-route](https://github.com/Kiriketsuki/agenKic-sKills/blob/main/skills/model-route/SKILL.md) | Recommends the optimal model tier (Haiku/Sonnet/Opus) for a task based on complexity and cost sensitivity. |
...
| [security-scan](https://github.com/Kiriketsuki/agenKic-sKills/blob/main/skills/security-scan/SKILL.md) | Audits Claude Code configuration for security vulnerabilities, misconfigurations, and injection risks using AgentShield. |
